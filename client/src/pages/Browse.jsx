...
const Browse = () => {
  ...
  return (
    <div style={{ textAlign: 'left' }}>
      ...
      {/* Filter Section */}
      <div style={{ border: '1px solid #ccc', padding: '15px', marginBottom: '20px', borderRadius: '8px', backgroundColor: '#fff' }}>
        ...
        <div style={{ display: 'flex', gap: '15px', flexWrap: 'wrap' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'flex-end' }}>
            <button
              ...
              style={{ padding: '8px 16px', borderRadius: '4px', border: '1px solid #ccc', backgroundColor: '#f9f9f9', cursor: 'pointer' }}
            >
              Clear Filters
            </button>
          </div>
