    ...
    <footer className="w-full bg-white border-t border-gray-100 mt-auto overflow-hidden">
      <div className="max-w-6xl mx-auto px-6 pt-16 pb-8 w-full">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-8 md:gap-16 text-left">
            ...
            <div className="flex flex-col">
              ...
              <ul className="list-none p-0 m-0 space-y-3">
                ...
                <li>
                  <a href="#" className="text-sm font-semibold text-gray-600 hover:text-[#4F46E5] transition-colors duration-200 no-underline">
                    About Valora
                  </a>
                </li>
              </ul>
            ...
            <div className="flex flex-col col-span-2 sm:col-span-1">
              ...
              <div className="flex items-center gap-3">
                {/* Globe Icon */}
                <a href="#" className="w-9 h-9 rounded-full bg-gray-50 border border-gray-100 flex items-center justify-center text-gray-500 hover:text-[#4F46E5] hover:bg-indigo-50 hover:border-indigo-100 transition-all duration-200">
        ...
        <div className="w-full pt-10 select-none overflow-hidden flex items-center justify-center">
          <h1 
            className="text-[6.5rem] sm:text-[10rem] md:text-[13rem] lg:text-[16rem] font-black tracking-widest uppercase m-0 leading-none text-gray-100 text-center"
